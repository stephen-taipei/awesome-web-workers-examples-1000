/**
 * Data Partitioner - Main Thread Script
 */
...
function processData(data) {
    ...
    items.forEach((item, i) => partitions[i % numPartitions].push(item));
    return { output: partitions.map((p, i) => ({ partition: i, items: p })), stats: { count: items.length, partitions: numPartitions } };
}
