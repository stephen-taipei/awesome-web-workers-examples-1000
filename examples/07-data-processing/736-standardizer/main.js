/**
 * Standardizer - Main Thread Script
 */
...
function processData(data) {
    ...
    const standardized = values.map(v => ({ original: v, standardized: (v - mean) / std }));
    return { output: standardized, stats: { count: values.length, mean, std, processed: standardized.length } };
}
