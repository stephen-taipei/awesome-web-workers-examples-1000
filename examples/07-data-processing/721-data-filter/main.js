/**
 * Data Filter - Main Thread Script
 */
...
function processData(data) {
    ...
    const filtered = items.filter(item => item.active === true || item.value > 50);
    return { output: filtered, stats: { count: items.length, matched: filtered.length } };
}
