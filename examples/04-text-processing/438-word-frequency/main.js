    ...
    worker.onmessage = function(e) {
        ...
        if (type === 'PROGRESS') {
            ...
            elements.resultStats.innerHTML = `
                ...
                <div class="stat-item"><span class="stat-label">Total Words:</span><span class="stat-value">${payload.stats.total}</span></div>
                <div class="stat-item"><span class="stat-label">Unique Words:</span><span class="stat-value">${payload.stats.unique}</span></div>
            `;
            elements.resultOutput.innerHTML = payload.frequencies.map(f =>
                `<div class="stat-item"><span class="stat-label">${f.word}</span><span class="stat-value">${f.count} (${f.percent}%)</span></div>`
            ).join('');
