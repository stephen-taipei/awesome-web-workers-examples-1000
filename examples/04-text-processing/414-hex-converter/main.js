/**
 * Hex Converter - Main Thread Script
 */
...
function initializeElements() {
    ...
    elements.toHexBtn = document.getElementById('to-hex-btn');
    elements.fromHexBtn = document.getElementById('from-hex-btn');
...
function setupEventListeners() {
    elements.toHexBtn.addEventListener('click', () => process('TO_HEX'));
    elements.fromHexBtn.addEventListener('click', () => process('FROM_HEX'));
}
