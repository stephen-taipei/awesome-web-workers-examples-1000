    ...
    worker.onmessage = function(e) {
        ...
        if (type === 'PROGRESS') {
            ...
            elements.resultStats.innerHTML = `
                ...
                <div class="stat-item"><span class="stat-label">Misspelled:</span><span class="stat-value" style="color:#f44336">${payload.stats.misspelled}</span></div>
            `;
            elements.resultOutput.innerHTML = payload.highlighted;
...
function processText() {
    ...
    worker.postMessage({ type: 'CHECK', payload: { text: elements.inputText.value } });
}
