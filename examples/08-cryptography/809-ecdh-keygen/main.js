...
document.addEventListener('DOMContentLoaded', function() {
    ...
    worker.onmessage = function(e) {
        ...
        if (type === 'PROGRESS') {
            ...
            document.getElementById('public-key').textContent = `x: ${payload.publicKey.x}, y: ${payload.publicKey.y}`;
    ...
    document.getElementById('generate-btn').onclick = function() {
        this.disabled = true;
        worker.postMessage({ type: 'GENERATE', payload: { curve: document.getElementById('curve-select').value }});
    };
});
