/**
 * AES-CTR Encryption - Main Thread
 */
...
function initializeElements() {
    ...
    elements.counterResult = document.getElementById('counter-result');
...
function handleWorkerMessage(event) {
    ...
    switch (type) {
        ...
        case 'ENCRYPT_RESULT':
            ...
            displayResult(payload.ciphertext, payload.counter, payload.duration, 'Encrypted');
...
function displayResult(output, counter, duration, status) {
    updateProgress(100, status);
    elements.outputResult.textContent = output;
    elements.counterResult.textContent = counter;
