...
highlightInput.addEventListener('input', () => highlightValue.textContent = highlightInput.value);
shadowInput.addEventListener('input', () => shadowValue.textContent = shadowInput.value);
...
function processImage() {
    ...
    worker.postMessage({
        ...
        highlightHue: parseInt(highlightInput.value),
        shadowHue: parseInt(shadowInput.value)
    });
}
