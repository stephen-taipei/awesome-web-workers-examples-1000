...
satInput.addEventListener('input', () => satValue.textContent = satInput.value);
...
function processImage() {
    ...
    worker.postMessage({ imageData: originalCtx.getImageData(0, 0, w, h), satBoost: parseInt(satInput.value) / 100 });
}
