...
const directionVal = document.getElementById('directionVal');
...
function processImage() {
    ...
    const params = {
        ...
        direction: parseInt(directionSlider.value)
    };
...
typeSelect.onchange = processImage;
intensitySlider.oninput = () => { updateVal(intensitySlider, intensityVal); processImage(); };
directionSlider.oninput = () => { updateVal(directionSlider, directionVal, '°'); processImage(); };
