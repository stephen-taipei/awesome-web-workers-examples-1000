...
const blocksSlider = document.getElementById('blocks');
...
blocksSlider.addEventListener('input', (e) => blocksValue.textContent = e.target.value);
...
function processImage() {
    ...
    worker.postMessage({
        ...
        blocks: parseInt(blocksSlider.value)
    });
}
