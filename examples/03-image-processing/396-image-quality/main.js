...
worker.onmessage = (e) => {
    ...
    sharpnessEl.textContent = e.data.sharpness.toFixed(1);
    contrastEl.textContent = e.data.contrast.toFixed(1);
    brightnessEl.textContent = e.data.brightness.toFixed(1);
