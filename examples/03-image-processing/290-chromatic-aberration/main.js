...
offsetInput.addEventListener('input', () => offsetValue.textContent = offsetInput.value);
...
function processImage() {
    ...
    worker.postMessage({ imageData: originalCtx.getImageData(0, 0, w, h), offset: parseInt(offsetInput.value) });
}
