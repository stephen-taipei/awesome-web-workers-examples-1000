...
curvatureSlider.addEventListener('input', (e) => curvatureValue.textContent = e.target.value);
scanlineSlider.addEventListener('input', (e) => scanlineValue.textContent = e.target.value);
...
function processImage() {
    ...
    worker.postMessage({
        ...
        curvature: parseInt(curvatureSlider.value) / 100,
        scanline: parseInt(scanlineSlider.value) / 100
    });
}
