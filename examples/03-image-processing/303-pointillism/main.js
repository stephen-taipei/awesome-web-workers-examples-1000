...
dotInput.addEventListener('input', () => dotValue.textContent = dotInput.value);
...
function processImage() {
    ...
    worker.postMessage({ imageData: originalCtx.getImageData(0, 0, w, h), dotSize: parseInt(dotInput.value) });
}
