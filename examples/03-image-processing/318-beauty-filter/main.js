...
whitenInput.addEventListener('input', () => whitenValue.textContent = whitenInput.value);
blushInput.addEventListener('input', () => blushValue.textContent = blushInput.value);
...
function processImage() {
    ...
    worker.postMessage({
        ...
        whiten: parseInt(whitenInput.value) / 100,
        blush: parseInt(blushInput.value) / 100
    });
}
