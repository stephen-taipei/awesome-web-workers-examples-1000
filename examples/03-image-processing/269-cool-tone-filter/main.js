// Cool Tone Filter - Main Thread

const imageInput = document.getElementById('imageInput');
const intensityInput = document.getElementById('intensity');
const intensityValue = document.getElementById('intensityValue');
const blueBoostInput = document.getElementById('blueBoost');
const blueBoostValue = document.getElementById('blueBoostValue');
...
blueBoostInput.addEventListener('input', function() {
    blueBoostValue.textContent = this.value;
});
...
applyBtn.addEventListener('click', function() {
    ...
    const blueBoost = parseInt(blueBoostInput.value);
    worker.postMessage({
...
resetBtn.addEventListener('click', function() {
    ...
    blueBoostInput.value = 30;
    blueBoostValue.textContent = '30';
    ...
    originalCtx.fillStyle = '#070a0f';
    originalCtx.fillRect(0, 0, 400, 300);
    originalCtx.fillStyle = '#3a5a7a';
...
downloadBtn.addEventListener('click', function() {
    ...
    link.download = 'cool-tone-filter-result.png';
