...
function initializeElements() {
    ...
    elements.modeBtns = document.querySelectorAll('[data-mode]');
...
function setupEventListeners() {
    ...
    elements.sigmaInput.addEventListener('input', () => {
        elements.sigmaValue.textContent = elements.sigmaInput.value;
    });
...
function displayResult(result) {
    ...
    elements.resultStats.innerHTML = `
        ...
        <div class="stat-item"><span class="stat-label">Kernel Size：</span><span class="stat-value">${result.kernelSize}x${result.kernelSize}</span></div>
    `;
}
