// Stereoscopic Projection - Main Thread
...
function processImage() {
    ...
    const parallax = parseInt(parallaxRange.value);
...
function reset() {
    ...
    parallaxRange.value = 10;
    parallaxValue.textContent = '10';
}
...
parallaxRange.addEventListener('input', () => {
    parallaxValue.textContent = parallaxRange.value;
});
