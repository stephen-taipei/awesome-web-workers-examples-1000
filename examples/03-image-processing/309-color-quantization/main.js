...
colorsInput.addEventListener('input', () => colorsValue.textContent = colorsInput.value);
...
function processImage() {
    ...
    worker.postMessage({ imageData: originalCtx.getImageData(0, 0, w, h), numColors: parseInt(colorsInput.value) });
}
