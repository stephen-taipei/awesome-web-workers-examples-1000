...
hueInput.addEventListener('input', () => hueValue.textContent = hueInput.value);
...
function processImage() {
    ...
    worker.postMessage({ imageData: originalCtx.getImageData(0, 0, w, h), hueShift: parseInt(hueInput.value) });
}
