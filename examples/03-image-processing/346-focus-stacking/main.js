...
function processImage() {
    ...
    worker.postMessage({
        ...
        sharpnessThreshold: parseInt(sharpnessSlider.value),
        blendRadius: parseInt(radiusSlider.value)
    });
}
