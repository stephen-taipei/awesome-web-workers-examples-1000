...
highlightSlider.addEventListener('input', (e) => highlightValue.textContent = e.target.value);
shadowSlider.addEventListener('input', (e) => shadowValue.textContent = e.target.value);
...
function processImage() {
    ...
    worker.postMessage({
        ...
        highlightEV: parseFloat(highlightSlider.value),
        shadowEV: parseFloat(shadowSlider.value)
    });
}
