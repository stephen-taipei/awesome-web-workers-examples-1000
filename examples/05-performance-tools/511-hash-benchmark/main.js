/**
 * #511 Hash Benchmark - Main Thread
 */
...
function displayResults(r) {
    ...
    elements.resultStats.innerHTML = `
        <div class="stat-item"><span class="stat-label">DJB2:</span><span class="stat-value">${r.djb2Time.toFixed(2)} ms</span></div>
        <div class="stat-item"><span class="stat-label">SDBM:</span><span class="stat-value">${r.sdbmTime.toFixed(2)} ms</span></div>
        <div class="stat-item"><span class="stat-label">FNV-1a:</span><span class="stat-value">${r.fnvTime.toFixed(2)} ms</span></div>
        <div class="stat-item"><span class="stat-label">Simple Hash:</span><span class="stat-value">${r.simpleTime.toFixed(2)} ms</span></div>
        <div class="stat-item"><span class="stat-label">Fastest:</span><span class="stat-value">${r.fastest}</span></div>
        <div class="stat-item"><span class="stat-label">Hashes/sec:</span><span class="stat-value">${(r.iterations / r.totalTime * 1000).toExponential(2)}</span></div>
    `;
