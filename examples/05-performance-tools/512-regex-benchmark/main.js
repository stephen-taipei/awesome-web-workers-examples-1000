/**
 * #512 Regex Benchmark - Main Thread
 */
...
function displayResults(r) {
    ...
    elements.resultStats.innerHTML = `
        <div class="stat-item"><span class="stat-label">Simple Match:</span><span class="stat-value">${r.simpleTime.toFixed(2)} ms</span></div>
        <div class="stat-item"><span class="stat-label">Complex Pattern:</span><span class="stat-value">${r.complexTime.toFixed(2)} ms</span></div>
        <div class="stat-item"><span class="stat-label">Capture Groups:</span><span class="stat-value">${r.captureTime.toFixed(2)} ms</span></div>
        <div class="stat-item"><span class="stat-label">Replace:</span><span class="stat-value">${r.replaceTime.toFixed(2)} ms</span></div>
